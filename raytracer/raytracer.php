...
if(isset($_GET['radius'])) {
	$rayTracer->sphere0Radius = floatval($_GET['radius']);
}	
if(isset($_GET['x'])) {
	$rayTracer->sphere0Position[0] = floatval($_GET['x']);
}	
if(isset($_GET['y'])) {
	$rayTracer->sphere0Position[1] = floatval($_GET['y']);
}	
if(isset($_GET['z'])) {
	$rayTracer->sphere0Position[2] = floatval($_GET['z']);
}	
if(isset($_GET['distance'])) {
	$rayTracer->viewPlaneDistance = floatval($_GET['distance']);
}	
