...
class QBSampleNearestHandler extends QBSampleHandler {
	...
	public function getHelperFunctions() {
		...
		$functions = array(
			array(
				"static void ZEND_FASTCALL qb_sample_nearest_$type(qb_interpreter_context *__restrict cxt, $cType *__restrict pixels, uint32_t width, uint32_t height, $cType x, $cType y, $cType *__restrict res_ptr) {",
	...
	public function getAction() {
		$type = $this->getOperandType(1);
		return "qb_sample_nearest_$type(cxt, op1_ptr, op2, op3, op4, op5, res_ptr);";
	}
}
