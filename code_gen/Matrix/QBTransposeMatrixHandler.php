	...
	public function getAction() {
		...
		if($this->operandSize == "variable") {
			if($this->addressMode == "ARR") {
				return "qb_transpose_cm_matrix_$type(op1_ptr, op1_ptr + op1_count, MATRIX1_ROWS, MATRIX1_COLS, res_ptr, res_ptr + res_count);";
			} else {
				return "qb_transpose_cm_matrix_$type(op1_ptr, NULL, MATRIX1_ROWS, MATRIX1_COLS, res_ptr, NULL);";
			}
		} else {
			if($this->addressMode == "ARR") {
				return "qb_transpose_cm_matrix_{$this->operandSize}x{$this->operandSize}_$type(op1_ptr, op1_ptr + op1_count, res_ptr, res_ptr + res_count);";
			} else {
