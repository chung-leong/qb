	...
	public function getAction() {
		...
		if($this->operandSize == "variable") {
			if($this->addressMode == "ARR") {
				return "qb_calculate_face_forward_$type(op1_start, op1_end, op2_start, op2_end, MATRIX2_ROWS, res_start, res_end);";
			} else {
				return "qb_calculate_face_forward_$type(op1_ptr, NULL, op2_ptr, NULL, MATRIX2_ROWS, res_ptr, NULL);";
			}
		} else {
			if($this->addressMode == "ARR") {
				return "qb_calculate_face_forward_{$this->operandSize}x_$type(op1_start, op1_end, op2_start, op2_end, res_start, res_end);";
			} else {
