	...
	public function getAction() {
		...
		if($this->operandSize == "variable") {
			if($this->addressMode == "ARR") {
				return "qb_normalize_array_$type(op1_start, op1_end, MATRIX2_ROWS, res_start, res_end);";
			} else {
				return "qb_normalize_array_$type(op1_ptr, NULL, MATRIX2_ROWS, res_ptr, NULL);";
			}
		} else {
			if($this->addressMode == "ARR") {
				return "qb_normalize_array_{$this->operandSize}x_$type(op1_start, op1_end, res_start, res_end);";
			} else {
