...
static void qb_link_results_all_operands(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
	uint32_t i;
...
static void qb_link_results_variable(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
	...
	if(variable->type == QB_OPERAND_RESULT_PROTOTYPE || variable->type == QB_OPERAND_EMPTY) {
...
static void qb_link_results_array_element(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
...
// link the value to the object property
static void qb_link_results_return(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
...
static void qb_link_results_print(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
	qb_operand *value = &operands[0];
...
// link the value to the object property
static void qb_link_results_free(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
	qb_operand *value = &operands[0];
	if(value->type == QB_OPERAND_RESULT_PROTOTYPE) {
		qb_result_destination *destination = qb_allocate_result_destination(cxt->pool);
...
static void qb_link_results_array_init(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
	qb_operand *value = &operands[0];
	if(value->type == QB_OPERAND_RESULT_PROTOTYPE) {
		value->result_prototype->parent = result_prototype;
	}
...
static void qb_link_results_array_append(qb_compiler_context *cxt, qb_op_factory *f, qb_operand *operands, uint32_t operand_count, qb_result_prototype *result_prototype) {
	qb_operand *value = &operands[0];
	if(value->type == QB_OPERAND_RESULT_PROTOTYPE) {
		value->result_prototype->parent = result_prototype;
	}
