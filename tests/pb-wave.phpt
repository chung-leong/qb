 ...
 * @param float32		$amplitude
 * @param float32		$frequency
 */
function filter(&$dst, $src, $center, $amplitude, $frequency) {
}

qb_compile();

filter($output, $image, array(125, 220), 5, 2);
