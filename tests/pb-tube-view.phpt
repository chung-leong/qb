...
/**
 * TubeView()   Tube View (Pixelero)
 *
 * @engine      qb
 * @import      pbj/tube-view.pbj
 *
 * @param       image   $pxl
 * @param       image   $src
 * @param       float32 $radius
 * @param       float32 $turbulence     Turbulence
 * @param       float32 $fade1  Fading on the edge of the tube
 * @param       float32 $fade2  Fading by distance
 * @param       float32[2]      $center Center point
 * @param       float32[4]      $bgColor        Background color
 *
 * @return      void
 */
