--TEST--
Use case: Mandelbulb radiolaria fractal (multicore)
--SKIPIF--
<?php 
...
$correct_path = "$folder/output/mandelbulb-radiolaria.correct.png";
$incorrect_path = "$folder/output/mandelbulb-radiolaria.incorrect.png";

$rayTracer = new Mandelbulb;
$rayTracer->julia = true;
$rayTracer->radiolaria = true;
