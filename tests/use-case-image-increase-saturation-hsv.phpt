--TEST--
Use case: saturation boost test (HSV colorspace)
--SKIPIF--
<?php 
...
$correct_path = "$folder/output/image-saturation-hsv.correct.png";
$incorrect_path = "$folder/output/image-saturation-hsv.incorrect.png";
test_function($image);
