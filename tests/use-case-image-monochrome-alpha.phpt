--TEST--
Use case: Monochrome image (alpha channel)
--EXTENSIONS--
gd
--SKIPIF--
<?php 
...
$correct_path = "$folder/output/image-monochrome-alpha.correct.png";
$incorrect_path = "$folder/output/image-monochrome-alpha.incorrect.png";
test_function($image);
