...
/**
 * @engine qb
 * @import pbj/mercator.pbj
 *
 * @param image			$dst
 * @param image			$src
 * @param float32		$center
 * @param float32		$width
 */
function filter(&$dst, $src, $center, $width) {}

qb_compile();

filter($output, $image, 320, 400);
