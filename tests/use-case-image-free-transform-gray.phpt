--TEST--
Use case: Image free transform (grayscale)
--SKIPIF--
<?php 
...
$correct_path = "$folder/output/image-free-transform-gray.correct.png";
$incorrect_path = "$folder/output/image-free-transform-gray.incorrect.png";
