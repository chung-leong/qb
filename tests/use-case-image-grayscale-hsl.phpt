--TEST--
Use case: grayscale conversion test (HSL colorspace)
--EXTENSIONS--
gd
--SKIPIF--
<?php 
...
$correct_path = "$folder/output/image-grayscale-hsl.correct.png";
$incorrect_path = "$folder/output/image-grayscale-hsl.incorrect.png";
test_function($image);
