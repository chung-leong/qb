...
typedef void (*qb_pbj_translator_proc)(qb_pbj_translater_context *cxt, qb_pbj_translator *t, qb_pbj_address **inputs, uint32_t intput_count, qb_pbj_address *output);
