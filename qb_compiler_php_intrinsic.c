...
static qb_intrinsic_function intrinsic_functions[] = {
	...
	{	0,	"transpose_cm",			qb_translate_intrinsic_unary_matrix_op,		1,		1,		&factory_transpose_cm		},
	{	0,	"det_cm",				qb_translate_intrinsic_unary_matrix_op,		1,		1,		&factory_determinant_cm		},
	{	0,	"inverse_cm",			qb_translate_intrinsic_unary_matrix_op,		1,		1,		&factory_inverse_cm			},
	...
	{	0,	"transpose_rm",			qb_translate_intrinsic_unary_matrix_op,		1,		1,		&factory_transpose_rm		},
	{	0,	"det_rm",				qb_translate_intrinsic_unary_matrix_op,		1,		1,		&factory_determinant_rm		},
	{	0,	"inverse_rm",			qb_translate_intrinsic_unary_matrix_op,		1,		1,		&factory_inverse_rm			},
