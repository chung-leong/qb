...
static qb_intrinsic_function intrinsic_functions[] = {
	...
	{	0,	"cabs",					NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_abs		},
	{	0,	"carg",					NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_arg		},
	{	0,	"cmult",				NULL,		qb_translate_intrinsic_complex,				2,		2,		&factory_complex_multiply	},
	{	0,	"cdiv",					NULL,		qb_translate_intrinsic_complex,				2,		2,		&factory_complex_divide		},
	{	0,	"cexp",					NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_exp		},
	{	0,	"clog",					NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_log		},
	{	0,	"csqrt",				NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_sqrt		},
	{	0,	"cpow",					NULL,		qb_translate_intrinsic_complex,				2,		2,		&factory_complex_pow		},
	{	0,	"csin",					NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_sin		},
	{	0,	"ccos",					NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_cos		},
	{	0,	"ctan",					NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_tan		},
	{	0,	"csinh",				NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_sinh		},
	{	0,	"ccosh",				NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_cosh		},
	{	0,	"ctanh",				NULL,		qb_translate_intrinsic_complex,				1,		1,		&factory_complex_tanh		},
};
